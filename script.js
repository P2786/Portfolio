document.addEventListener('DOMContentLoaded', function() {
    try {
        ...
        if (typeof Typed !== 'undefined') {
            new Typed('#typed', {
                strings: ['Data Analysis','Front-End Developer', 'Full-Stack Devloper', 'Future-Ready Coder'],
                typeSpeed: 50,
                backSpeed: 30,
                backDelay: 2000,
                loop: true
        ...
        const projects = [
            {
                ...
                description: 'Real-time chat application with theme switching and image sharing capabilities.',
            ...
            {
                title: 'Skin Care System',
                description: 'Complete Skin Care system with Netlify frontend and PHP+MySQL backend.',
